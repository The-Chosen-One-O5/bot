...
def test_scheduler():
    ...
    try:
        ...
        # Test adding repeating message
        assert scheduler.add_repeating_message(-123456, "12:00", (datetime.now() + timedelta(days=1)).strftime("%Y-%m-%d"), "Repeating test message: {date}")
        print("✅ Repeating message scheduling works")
