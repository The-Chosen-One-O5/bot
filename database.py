...
class BotDatabase:
            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                cursor.execute('''
                    CREATE TABLE IF NOT EXISTS scheduled_messages (
                        ...
                        repeat_until_date TEXT, -- For repeating messages
                        is_active BOOLEAN DEFAULT 1,
                        created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    ...
    def add_scheduled_message(self, chat_id: int, message_type: str, schedule_time: str, 
                            message_template: str, target_date: str = None, title: str = None, repeat_until_date: str = None) -> bool:
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                cursor.execute('''
                    ...
                    (chat_id, message_type, schedule_time, message_template, target_date, title, repeat_until_date)
                    VALUES (?, ?, ?, ?, ?, ?, ?)
                ''', (chat_id, message_type, schedule_time, message_template, target_date, title, repeat_until_date))
                conn.commit()
